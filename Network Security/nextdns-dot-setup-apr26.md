# NextDNS with DNS-over-TLS (DoT) Implementation — Early April 2026
...
| Control D | Yes | Yes | No (free tier) | No configuration without account |
...
**Router:** supports DoT natively in firmware
